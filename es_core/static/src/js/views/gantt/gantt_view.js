odoo.define('es_core.GanttView', function (require) {
"use strict";

var AbstractView = require('web.AbstractView');
var core = require('web.core');
var session = require('web.session');
var GanttModel = require('es_core.GanttModel');
var GanttRenderer = require('es_core.GanttRenderer');
var GanttController = require('es_core.GanttController');
...
var GanttView = AbstractView.extend({
    cssLibs: [
        "/es_core/static/libs/dhtmlxGantt/codebase/dhtmlxgantt.css"
    ],
    jsLibs: [
        "/es_core/static/libs/dhtmlxGantt/sources/dhtmlxcommon.js",
        "/es_core/static/libs/dhtmlxGantt/codebase/locale/locale" + locale_suffix + ".js"
    ],
