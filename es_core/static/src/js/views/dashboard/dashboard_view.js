odoo.define('es_core.DashboardView', function (require) {
"use strict";
    ...
    var DashboardController = require('es_core.DashboardController');
    var DashboardModel = require('es_core.DashboardModel');
    var DashboardRenderer = require('es_core.DashboardRenderer');
