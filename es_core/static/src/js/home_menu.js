odoo.define('es_core.HomeMenu', function (require) {
"use strict";
    ...
    var HomeMenu = Widget.extend({
        ...
        init: function (parent, menuData) {
            ...
            // load tips for START SCREEN
            var ui_context = {
                'cxt_view_type' : 'START_SCREEN'
            };
            ...
            session.rpc('/notification/tips/load', context, { shadow: true }).then(function(result){
                core.bus.trigger('on_load_tips', result);
            });
        },
        /**
         * @override
            ...
            utils.traversePath(menuData, function (menuItem, parents) {
                ...
                if (!menuItem.parent_id) {
                    if (menuItem.web_icon_data) {
                        ...
                        item.web_icon_data = '/es_core/static/src/img/default_icon_app.png';
                    }
                } else {
